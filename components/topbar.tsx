...
// ALTERAÇÃO: Importando Dialog em vez de AlertDialog
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  DialogTitle,
  DialogTrigger,
  DialogClose, // Importando DialogClose para o botão de cancelar
  ...
  return (
    <header className="flex h-20 items-center justify-between shadow-sm shadow-primary/10 bg-card px-4 md:px-8 flex-shrink-0">
      ...
      <div className="flex items-center gap-3 md:gap-4">
        ...
        {/* ALTERAÇÃO: Usando Dialog em vez de AlertDialog */}
        <Dialog>
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56">
              ...
              <DropdownMenuSeparator />
              {/* ALTERAÇÃO: O gatilho agora é para o Dialog */}
