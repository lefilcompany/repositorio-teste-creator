        ...
        <div>
          ...
          <div className="space-y-4 text-left">
            <div className="p-3 bg-muted/50 rounded-lg">
              ...
              <p className="font-semibold text-foreground">{brand.responsible}</p>
            </div>
            <div className="p-3 bg-muted/50 rounded-lg">
              <p className="text-sm text-muted-foreground">Data de Criação</p>
              <p className="font-semibold text-foreground">{formatDate(brand.createdAt)}</p>
            </div>
            {wasUpdated && (
              <div className="p-3 bg-muted/50 rounded-lg">
                <p className="text-sm text-muted-foreground">Última Atualização</p>
                <p className="font-semibold text-foreground">{formatDate(brand.updatedAt)}</p>
              </div>
            )}
          </div>
        </div>
